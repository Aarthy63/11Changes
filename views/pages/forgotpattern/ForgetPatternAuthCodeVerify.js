...
const ForgetPatternAuthCodeVerify = () => {
    ...
    return (
        ...
        <>
            <div className='p-5 twoFactor-Bg bg-primary' style={{ minHeight: "100vh" }}>
                <h1 className='text-center mb-5 text-primary input-group-text' >ENTER YOUR OTP</h1>
                <div className='row'>
                    <div className='col-lg-5'>
                        <form onSubmit={verifyAuthCode}>
                            <div className='mb-5'>
                                <div>
                                    <>
                                        <h5 className='mt-5 mb-3 text-black'>Enter Your Authetication Key</h5>
                                        <OTPInput value={OTP} onChange={setOTP} autoFocus OTPLength={6} otpType="number" disabled={false} />
                                    </>
                                </div>
                                <button className='btn mt-4  btn-lg btn-success ' type="submit">Verify</button>
                            </div>
