...
export const usersApi = createApi({
    ...
    endpoints: (builder) => ({
      ...
      query: () => "users/getcontents",
    providesTags: ["User"],
    }),  
    getProfileDetails: builder.mutation({
        query: (body) => ({
            url: 'users/getProfileDetails',
            method: 'POST',
            body
        }),
        invalidatesTags: ['User']
    ...
    profileDetailsUpdate: builder.mutation({
        query: (formData) => ({
            url: 'users/profileDetailsUpdates',
            method: 'POST',
            body: formData
        }),
        invalidatesTags: ['User']
